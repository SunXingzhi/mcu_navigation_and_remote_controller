...
//	set_pin(MOTOR_DIRECTION_GPIO, MOTOR_DIRECTION_CONTROL_RIGHT_PIN);
	...
	reset_pin(MOTOR_DIRECTION_GPIO, GPIO_Pin_12);
	set_pin(MOTOR_DIRECTION_GPIO, GPIO_Pin_13);
//	reset_pin(MOTOR_DIRECTION_GPIO, GPIO_Pin_13);
	reset_pin(MOTOR_DIRECTION_GPIO, GPIO_Pin_14);
	set_pin(MOTOR_DIRECTION_GPIO, GPIO_Pin_15);
